...
public class MainActivity extends Activity
{
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		aa = new ArrayAdapter<WifiP2pDevice>(this,
		...
		p2pEnabled = new IntentFilter(
				WifiP2pManager.WIFI_P2P_STATE_CHANGED_ACTION);

		buttonDiscover = (Button) findViewById(R.id.button2);
		...
		/*
		 * Button buttonEnable = (Button)findViewById(R.id.);
		 * buttonEnable.setOnClickListener(new OnClickListener() { public void
		 * onClick(View v) {
		 * 
									...
									WifiP2pInfo info)
							{
								...
								if (info.groupFormed)
								{
									...
									else if (info.groupFormed)
									{
										...
										initiateClientSocket(info.groupOwnerAddress
												.toString());
									}
								}
							}
